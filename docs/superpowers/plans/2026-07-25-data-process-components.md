...
- [x] **Step 1: Extend the workbench test with six registered entries**
...
- [x] **Step 4: Register entries 04–06**
...
- [x] **Step 3: Implement the presenter-safe renderer**
...
- [x] **Step 4: Add scoped Precision Spatial styles**
...
- [x] **Step 1: Write failing ring tests**
...
- [x] **Step 3: Implement the SVG ring**
...
- [x] **Step 4: Add scoped ring styles**
...
- [x] **Step 3: Implement normalized looping keyframes**
...
- [x] **Step 4: Add scoped process styles**
...
- [x] **Step 1: Add rail thumbnails and six-module copy**
