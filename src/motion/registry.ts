...
export const motionRegistry: RegisteredMotion[] = [
  ...
  },
  {
    ...
    controls: [
      ...
      { type: 'select', key: 'item1Level', label: '分支一层级', options: [
        { label: '一级分支', value: '0' },
        { label: '二级分支', value: '1' },
        { label: '三级分支', value: '2' },
      ] },
      { type: 'text', key: 'item2', label: '分支二', maxLength: 12 },
      { type: 'select', key: 'item2Level', label: '分支二层级', options: [
        { label: '一级分支', value: '0' },
        { label: '二级分支', value: '1' },
        { label: '三级分支', value: '2' },
      ] },
      { type: 'text', key: 'item3', label: '分支三', maxLength: 12 },
      { type: 'select', key: 'item3Level', label: '分支三层级', options: [
        { label: '一级分支', value: '0' },
        { label: '二级分支', value: '1' },
        { label: '三级分支', value: '2' },
      ] },
      { type: 'text', key: 'item4', label: '分支四', maxLength: 12 },
      { type: 'select', key: 'item4Level', label: '分支四层级', options: [
        { label: '一级分支', value: '0' },
        { label: '二级分支', value: '1' },
        { label: '三级分支', value: '2' },
      ] },
      { type: 'text', key: 'item5', label: '分支五', maxLength: 12 },
      { type: 'select', key: 'item5Level', label: '分支五层级', options: [
        { label: '一级分支', value: '0' },
        { label: '二级分支', value: '1' },
        { label: '三级分支', value: '2' },
      ] },
      { type: 'text', key: 'item6', label: '分支六', maxLength: 12 },
      { type: 'select', key: 'item6Level', label: '分支六层级', options: [
        { label: '一级分支', value: '0' },
        { label: '二级分支', value: '1' },
        { label: '三级分支', value: '2' },
      ] },
